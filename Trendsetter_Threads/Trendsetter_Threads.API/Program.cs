...
using Trendsetter_Threads.API.Repository.Service;
...
builder.Services.AddDbContext<TrendsetterDbContext>(options =>
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    c.AddSecurityRequirement(new OpenApiSecurityRequirement {
   {
    ...
    c.OperationFilter<BearerTokenPrefixOperationFilter>();
});
